                ...
                <div class="row" id="save-modal">
                    <form method="post" id="save-form" name="save-form" enctype="multipart/form-data" class="col-md-4">
                        ...
                        <div class="row">
                            <!--Estableciendo el tamaño del que tomará el Input field-->
                            <div class="input-field col s12 m6">
                                <button class="btn waves-effect blue-grey" type="submit" id="action" name="action">Enviar código
                ...
                <div class="row" id="save-modal2">
                    ...
                    <input class="hide" type="text" id="usuario2" name="usuario2"/>
                        ...
                        <div class="row">
                            <!--Estableciendo el tamaño del que tomará el Input field-->
                            <div class="input-field col s12 m6">
                                <input id="clave" type="password" name="clave" maxlength="16" class="validate" required>
                                <label for="clave">Nueva contraseña:</label>
                            </div>
                            <!--Estableciendo el tamaño del que tomará el Input field-->
                            <div class="input-field col s12 m6">
                                <input id="confirmar" type="password" name="confirmar"  maxlength="16" class="validate" required>
