            ...
            <form method="post" id="search-form">
                <div class="row">
                    ...
                    <div class="input-field s12 m6">
                        ...
                        <a href="../../app/reports/productos_proveedor.php" target="_blank" class="btn waves-effect light-blue darken-4 tooltipped" data-tooltip="Reporte de productos por proveedor"><i class="material-icons">assignment</i></a>
                    </div>
                </div>
            </form>
