...
<body>
    <header>
        ...
        <div class="navbar-fixed">
            <nav class="nav-extended light-blue darken-4">
                ...
                <div class="nav-content nav-wrapper">
                    <!--Se crea la lista de elementos que van en la parte inferior del navbar-->
                    <ul class="tabs tabs-transparent hide-on-med-and-down">
                        ...
                        <!--Boton para el carrito de compras alineado a la derecha-->
        ...
        <!--Se crea la lista para los elementos que van en el sidenav-->
        <ul id="slide-out" class="sidenav">
            <li>
                <!--Parte superior con la información del usuario-->
                <div class="user-view">
            ...
            <li>
                <!--Divisor de la parte superior e inferior del sidenav-->
                <div class="divider"></div>
            </li>
            <li>
                <!--Buscador para el sidenav-->
                <form>
                    <div class="input-field">
                        <input id="search" type="search" required>
            ...
            <!--Lista colapsable para visualizar las categorías-->
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <!--Colapsable para los perifericos-->
                                <li class="no-padding">
                                    <ul class="collapsible collapsible-accordion">
                                        <li>
    ...
    <main>
        <div class="row">
            <div class="col s12 m2">
                <!--Menu lateral para ver las categorías, perifericos, repuestos y marcas-->
    ...
    <!--Footer de la pagina con los enlaces a las redes sociales-->
