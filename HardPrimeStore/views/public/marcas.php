        ...
        <div class="col s12 m10">            
                ...
                <div class="row">
                    <div class="col s12 m3">
                        <div class="card">
                            <div class="card-image">
                                <img src="../../resources/img/public/HP.jpg" width="100" height="200">
                    ...
                    <div class="col s12 m3">
                        <div class="card">
                            <div class="card-image">
                                <img src="../../resources/img/public/HP2.jpg" width="100" height="200">
                                <a class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">add_shopping_cart</i></a>
                            </div>
                            <div class="card-content">
                    ...
                    <div class="col s12 m3">
                        <div class="card">
                            <div class="card-image">
                                <img src="../../resources/img/public/HP3.jpg" width="100" height="200">
                                <a class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">add_shopping_cart</i></a>
                            </div>
                            <div class="card-content">
                    ...
                    <div class="col s12 m3">
                        <div class="card">
                            <div class="card-image">
                                <img src="../../resources/img/public/HP4.png" width="100" height="200">
                                <a class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">add_shopping_cart</i></a>
                            </div>
                            <div class="card-content">
                ...
                <div class="row">
                    <div class="col s12 m3">
                        <div class="card">
                            <div class="card-image">
                                <img src="../../resources/img/public/HP5.png" width="100" height="200">
                                <a class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">add_shopping_cart</i></a>
                            </div>
                            <div class="card-content">
