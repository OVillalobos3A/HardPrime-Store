        ...
        content += `
          <tr>
              ...
              <td>
                ...
                <a href="#" onclick="openDeleteDialog(${row.id_producto})" class="btn-floating btn waves-effect red tooltipped" data-tooltip="Eliminar"><i class="material-icons" title="Eliminar registro">delete</i></a>
              </td>
          </tr>
      `;
    });
